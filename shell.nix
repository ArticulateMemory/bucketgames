...
pkgs.mkShellNoCC {
    ...
    shellHook = ''
        mkdir -p $BASE_PATH/src/pybucketgames/_static/purgecss
        
        alias updatecss="npm i && npx purgecss --css $BASE_PATH/src/pybucketgames/_static/bootstrap.min.css --content $BASE_PATH/src/pybucketgames/templates/*.html $BASE_PATH/*/bucket.html $BASE_PATH/*/game.html $BASE_PATH/*/*/bucket.html $BASE_PATH/*/*/game.html $BASE_PATH/*/_website/**/*.html $BASE_PATH/*/_website/*.html --output $BASE_PATH/src/pybucketgames/_static/purgecss"
